...
import lady from '../assets/ladyonphonne.svg'
            ...
            <div className="body">
                <section className='first-section'>
                    <div className="first-section-text">
                        ...
                        <p>Urudi offers an avenue where you can make profit, as a fan.</p>
                        <Link to='/pre-signup'>
                            <button>
                                <b>Get Started </b> &nbsp; >
                            </button>
                ...
                <section className='fourth-section'>
                    <img src={lady} alt="lady on phone" />
                    <h1>
                        Be more than a fan <br />
                        Be a <span>STAKEHOLDER</span> 
                    </h1>
                </section>
